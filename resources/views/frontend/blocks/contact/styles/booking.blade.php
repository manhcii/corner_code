            ...
            <div class="container">
                ...
                <div class="page-contact-main">
                    <div class="page-contact-form">
                        <form action="{{ route('frontend.contact.store') }}" class="contact-form booking-form form_ajax" id="bookingNow" method="POST">
                            @csrf
                    ...
                    <div class="booknow-time">
                        <ul class="booknow-time-info">
                            ...
                            @foreach ($block_childs as $item)
                                ...
                                @endphp
                                <li>
                                    <p class="booknow-time-name">{{ $title_childs }}</p>
                                    <p class="booknow-time-day">{{ $brief }}</p>
                                    <p class="booknow-time-hours">{{ $content }}</p>
                                </li>
                            @endforeach
                        @endif
                        </ul>
...
@endif
<script src="{{ asset('themes/frontend/assets/js/booknow.js') }}"></script>
