<script src="{{ asset('themes/frontend/assets/bootstrap/js/bootstrap.js') }}"></script>
<script src="https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.js"></script>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="{{ asset('themes/frontend/assets/js/sweetalert2.all.min.js') }}"></script>
<script src="{{ asset('themes/frontend/assets/js/about-us.js') }}"></script>
<script src="{{ asset('themes/frontend/corner/js/main.js') }}"></script>
<script src="{{ asset('themes/frontend/corner/js/index.js') }}"></script>
<script src="{{ asset('themes/frontend/corner/js/article.js') }}"></script>
<script src="{{ asset('themes/frontend/assets/js/blog-detail.js') }}"></script>
<script src="{{ asset('themes/frontend/corner/js/product.js') }}"></script>
...
<script>
    ...
    //     });
        ...
        $('.btn-wishlist .product-btn').on('click', function(e) {
            ...
            $.ajax({
                url: '{{ route('frontend.wishlist.check') }}',
                method: "POST",
                data: {
                    _token: '{{ csrf_token() }}',
                    id: id,
        ...
        $(document).on('click', '.btn-wishlist .product-btn.added', function(e) {
            ...
            $.ajax({
                url: '{{ route('frontend.wishlist.delete') }}',
                method: "POST",
                data: {
                    _token: '{{ csrf_token() }}',
                    id: id,
    ...
    //     var lang = '{{ $locale ?? 'vi' }}';
    //     var url = "{{ route('frontend.view_more') }}";
    //     var items = '';
