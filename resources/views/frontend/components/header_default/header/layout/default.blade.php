@if ($component)
    ...
    <div class="header-right">
        ...
        <div class="header-cart position-relative">
          <a href="{{ route('frontend.page',['taxonomy'=>'gio-hang']) }}" class="header-cart-img" title="Cart">
            <svg
              width="17"
              height="17"
              viewBox="0 0 17 17"
          ...
          <div class="header-cart-quantity position-absolute">{{ session('cart') ? count(session('cart')) : 0 }}</div>
        </div>
      </div>
@endif
