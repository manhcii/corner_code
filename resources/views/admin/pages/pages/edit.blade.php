                                ...
                                <div class="row">
                                            ...
                                            <div class="box-header with-border">
                                                <h3>
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-url="{{ route('block_contents.create',['page' => $detail->id]) }}">
                                                        @lang('Add Block Content')
                                                    </button>
                                                    <div id="dialog">
                                                        <iframe id="iframe_block"
                                                            src="{{ route('block_contents.create', ['page' => $detail->id]) }}"
                                                            {{-- src="{{ route('block_contents.edit', [74, 'page' => 1]) }}" --}} frameborder="0.5" width="100%"
                                                            height="100%"></iframe>
                                                    </div>
                                                </h3>
                                            </div>
                                                                    ...
                                                                    <div class="dd-handle ">
                                                                        ...
                                                                        <span class="dd-nodrag pull-right">
                                                                            ...
                                                                            <a data-id="{{ $item->id }}"
                                                                                ...
                                                                                data-url="{{ route('block_contents.edit', [$item->id]) }}">
                                                                                        ...
                                                                                        <div class="dd-handle ">
                                                                                            ...
                                                                                            <span
                                                                                                ...
                                                                                                <a data-id="{{ $item_sub_1->id }}"
                                                                                                    class="show_dialog cursor kudo"
                                                                                                    data-title="@lang('Edit Block')"
                                                                                                    data-url="{{ route('block_contents.edit', [$item_sub_1->id]) }}">
                                                                                                    <i
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <span
                                                                                                                    ...
                                                                                                                    <a data-id="{{ $item_sub_2->id }}"
                                                                                                                        class="show_dialog cursor kudo"
                                                                                                                        data-title="@lang('Edit Block')"
                                                                                                                        data-url="{{ route('block_contents.edit', [$item_sub_2->id]) }}">
                                                                                                                        <i
                                                                                                                            class="fa fa-edit fa-edit"></i>
                                                                                                                    </a>
                                                                                                                    <a data-id="{{ $item_sub_2->id }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="box box-primary">
                                            ...
                                            <div class="box-body">
                                                @foreach ($widgets_config as $val_config)
                                                    <div class="form-group">
                                                        <label>{{ $val_config->name }}</label>
                                                        <ul class="list-relation row">
                                                            @foreach ($widgets as $item)
                                                                @if ($item->widget_code == $val_config->widget_code)
                                                                    <div class="col-md-6">
                                                                        <li>
                                                                            <label for="page-{{ $item->id }}">
                                                                                <input id="page-{{ $item->id }}"
                                                                                    name="json_params[widget][{{ $val_config->widget_code }}]"
                                                                                    class="val_widget" type="radio"
                                                                                    value="{{ $item->id }}"
                                                                                    {{ in_array($item->id, $detail->json_params->widget ?? []) ? 'checked' : '' }}>
