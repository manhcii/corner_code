                                                                        ...
                                                                        <form role="form"
                                                                            ...
                                                                            <div class="form-body">
                                                                                ...
                                                                                <div class="image-mega form-group mb-3">
                                                                                    <label for="menu-node-title-1"
                                                                                        class="control-label"
                                                                                        data-update="title">@lang('Image Url Title')</label>
                                                                                    <input class="form-control"
                                                                                        placeholder="Image Title"
                                                                                        name="json_params[img_title]"
                                                                                        type="text"
                                                                                        value="{{ $item->json_params->img_title ?? '' }}">
                                                                                </div>
                                                                                <div class="image-mega form-group mb-3">
                                                                                    <label for="menu-node-title-1"
                                                                                        class="control-label"
                                                                                        data-update="title">@lang('Image Url Link')</label>
                                                                                    <input class="form-control"
                                                                                        placeholder="Image Link"
                                                                                        name="json_params[img_link]"
                                                                                        type="text"
                                                                                        value="{{ $item->json_params->img_link ?? '' }}">
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label>@lang('Image')</label>
                                                                                    <div class="input-group">
