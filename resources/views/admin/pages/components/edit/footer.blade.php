                        ...
                        <div class="tab-pane active" id="tab_1">
                            <form class="form-component" role="form" action="{{ route(Request::segment(2) . '.update', $detail->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>@lang('Link youtube')</label>
                                            <textarea name="json_params[link_yt]" id="brief" class="form-control" rows="3">{{ old('json_params[link_yt]') ?? ($detail->json_params->link_yt ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
