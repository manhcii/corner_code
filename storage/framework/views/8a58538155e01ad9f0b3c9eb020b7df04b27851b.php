            ...
            <form action="<?php echo e(route(Request::segment(2) . '.index')); ?>" method="GET">
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Component type'); ?></label>
                                <select name="component_code" id="component_code" class="form-control select2"
                                    ...
                                    <?php $__currentLoopData = $component_configs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->component_code); ?>"
                                            <?php echo e(isset($params['component_code']) && $item->component_code == $params['component_code'] ? 'selected' : ''); ?>>
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">
                    ...
                    <?php echo app('translator')->get('Component list'); ?>
                </h3>
                    ...
                    <table class="table table-hover table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('Component type'); ?></th>
                                    ...
                                    <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                                        ...
                                        <tr class="valign-middle">
                                            <td>
                                                ...
                                                <br>
                                                <?php echo e($row->json_params->brief->$lang??$row->brief); ?>

                                            </td>
                                            <td>
                                                <?php echo e($row->component_name); ?> (<?php echo e($row->component_code); ?>)
                                            </td>

                                            <td>
                                                <input data-token="<?php echo e(csrf_token()); ?>" data-url="<?php echo e(route('admin.loadOrderVeryModel',['table'=>'components','id'=>$row->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($row->iorder?$row->iorder:0); ?>" style="width:50px" />
                                            </td>
                                            <td>
                                            ...
                                            <td class="wrap-load-active" data-token="<?php echo e(csrf_token()); ?>" data-url="<?php echo e(route('admin.loadStatusComponent',['id'=>$row->id])); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/admin/pages/components/index.blade.php ENDPATH**/ ?>