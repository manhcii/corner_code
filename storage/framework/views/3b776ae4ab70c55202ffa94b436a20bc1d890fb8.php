                            ...
                            <div class="tab-pane active" id="tab_1">
                                ...
                                <div class="row">
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-header with-border">
                                                <h3>
                                                    ...
                                                    <button type="button"
                                                        class="show_dialog btn btn-sm btn-warning pull-right kudo"
                                                        data-title="<?php echo app('translator')->get('Add Block Content'); ?>" data-page="<?php echo e($detail->id); ?>"
                                                        data-url="<?php echo e(route('block_contents.create',['page' => $detail->id])); ?>">
                                                        <?php echo app('translator')->get('Add Block Content'); ?>
                                                    </button>
                                                    <div id="dialog">
                                                        <iframe id="iframe_block"
                                                            src="<?php echo e(route('block_contents.create', ['page' => $detail->id])); ?>"
                                                             frameborder="0.5" width="100%"
                                                            height="100%"></iframe>
                                                    </div>
                                                </h3>
                                            </div>
                                                                    ...
                                                                    <div class="dd-handle ">
                                                                        ...
                                                                        <span class="dd-nodrag pull-right">
                                                                            ...
                                                                            <a data-id="<?php echo e($item->id); ?>"
                                                                                class="show_dialog cursor kudo"
                                                                                data-title="<?php echo app('translator')->get('Edit Block'); ?>"
                                                                                data-url="<?php echo e(route('block_contents.edit', [$item->id])); ?>">
                                                                                        ...
                                                                                        <div class="dd-handle ">
                                                                                            ...
                                                                                            <span
                                                                                                ...
                                                                                                <a data-id="<?php echo e($item_sub_1->id); ?>"
                                                                                                    class="show_dialog cursor kudo"
                                                                                                    data-title="<?php echo app('translator')->get('Edit Block'); ?>"
                                                                                                    data-url="<?php echo e(route('block_contents.edit', [$item_sub_1->id])); ?>">
                                                                                                    <i
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <span
                                                                                                                    ...
                                                                                                                    <a data-id="<?php echo e($item_sub_2->id); ?>"
                                                                                                                        class="show_dialog cursor kudo"
                                                                                                                        data-title="<?php echo app('translator')->get('Edit Block'); ?>"
                                                                                                                        data-url="<?php echo e(route('block_contents.edit', [$item_sub_2->id])); ?>">
                                                                                                                        <i
                                                                                                                            class="fa fa-edit fa-edit"></i>
                                                                                                                    </a>
                                                                                                                    <a data-id="<?php echo e($item_sub_2->id); ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="box box-primary">
                                            <div class="box-header with-border">
                                                <h3><?php echo app('translator')->get('Setting Widgets'); ?>
                                                    <button id="reset_witget" type="button"
                                                        class="btn btn-sm btn-warning pull-right">
                                                        <?php echo app('translator')->get('Reset Widget'); ?>
                                                    </button>

                                                </h3>
                                            </div>
                                            <div class="box-body">
                                                <?php $__currentLoopData = $widgets_config; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val_config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="form-group">
                                                        <label><?php echo e($val_config->name); ?></label>
                                                        <ul class="list-relation row">
                                                            <?php $__currentLoopData = $widgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($item->widget_code == $val_config->widget_code): ?>
                                                                    <div class="col-md-6">
                                                                        <li>
                                                                            <label for="page-<?php echo e($item->id); ?>">
                                                                                <input id="page-<?php echo e($item->id); ?>"
                                                                                    name="json_params[widget][<?php echo e($val_config->widget_code); ?>]"
                                                                                    class="val_widget" type="radio"
                                                                                    value="<?php echo e($item->id); ?>"
                                                                                    <?php echo e(in_array($item->id, $detail->json_params->widget ?? []) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/admin/pages/pages/edit.blade.php ENDPATH**/ ?>