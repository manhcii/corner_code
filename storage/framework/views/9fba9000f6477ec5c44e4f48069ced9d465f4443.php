                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        placeholder="<?php echo app('translator')->get('Title'); ?>" value="<?php echo e(old('name')); ?>"
                                                        required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="json_params[brief][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]" class="form-control"
                                                        rows="5"><?php echo e(old('json_params[brief][' . $lang != '' ? $lang : $languageDefault->lang_code . ']')); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="json_params[content][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]" class="form-control"
                                                            id="content_vi"><?php echo e(old('json_params[content][' . $lang != '' ? $lang : $languageDefault->lang_code . ']')); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input
                                                        name="json_params[seo_title][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]"
                                                        class="form-control"
                                                        value="<?php echo e(old('json_params[seo_title][' . $lang != '' ? $lang : $languageDefault->lang_code . ']')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input
                                                        name="json_params[seo_keyword][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]"
                                                        class="form-control"
                                                        value="<?php echo e(old('json_params[seo_keyword][' . $lang != '' ? $lang : $languageDefault->lang_code . ']')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input
                                                        name="json_params[seo_description][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]"
                                                        class="form-control"
                                                        value="<?php echo e(old('json_params[seo_description][' . $lang != '' ? $lang : $languageDefault->lang_code . ']')); ?>">
                                                </div>
                                            </div>
                                                        ...
                                                        <li>
                                                            <label for="page-<?php echo e($item->id); ?>">
                                                                ...
                                                                <input id="page-<?php echo e($item->id); ?>"
                                                                    ...
                                                                    type="checkbox"
                                                                    <?php echo e(isset($detail->json_params->$val_name) && in_array($item->id, $detail->json_params->$val_name) ? 'checked' : ''); ?>
                                            ...
                                            <li>
                                                <label for="page-<?php echo e($item->id); ?>">
                                                    <input id="page-<?php echo e($item->id); ?>" name="relation[]"
                                                        <?php echo e(isset($relationship) && collect($relationship)->firstWhere('taxonomy_id', $item->id) != null ? 'checked' : ($loop->index == 0 ? 'checked' : '')); ?>
                                ...
                                <select name="json_params[template]" id="template" class="form-control select2"
                                    ...
                                    <?php if(isset($route_default['template'])): ?>
                                        <?php $__currentLoopData = $route_default['template']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item['name']); ?>" <?php echo e($loop->index == 0 ? 'selected' : ''); ?>>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn_search', function() {
                ...
                let is_type = $('#search_taxonomy_id').val();
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\flavor-fusion\resources\views/admin/pages/cms_posts/create.blade.php ENDPATH**/ ?>