                                ...
                                <div class="d-flex-wap">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Icon'); ?></label>
                                            <input type="text" class="form-control" name="icon"
                                                placeholder="Ex: fa fa-folder" value="<?php echo e(old('icon')??$detail->icon); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="json_params[style]" class="form-control select2"
                                                style="width: 100%">
                                                <?php $__currentLoopData = $blocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($items->block_code == $detail->block_code): ?>
                                                        <?php
                                                            $json_params = json_decode($items->json_params);
                                                        ?>
...
<?php echo $__env->make('admin.layouts.block', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\flavor-fusion\resources\views/admin/pages/block_contents/edit/featured_category.blade.php ENDPATH**/ ?>