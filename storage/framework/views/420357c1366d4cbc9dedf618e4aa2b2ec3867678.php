...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-component" role="form" action="<?php echo e(route(Request::segment(2) . '.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\flavor-fusion\resources\views/admin/pages/components/create.blade.php ENDPATH**/ ?>