                        ...
                        <div class="tab-pane active" id="tab_1">
                            <form class="form-component" role="form" action="<?php echo e(route(Request::segment(2) . '.update', $detail->id)); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Link youtube'); ?></label>
                                            <textarea name="json_params[link_yt]" id="brief" class="form-control" rows="3"><?php echo e(old('json_params[link_yt]') ?? ($detail->json_params->link_yt ?? '')); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/admin/pages/components/edit/footer.blade.php ENDPATH**/ ?>