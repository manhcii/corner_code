                                        ...
                                        <div class="d-flex-wap">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="price"
                                                        placeholder="<?php echo app('translator')->get('Price'); ?>" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="price_old"
                                                        placeholder="<?php echo app('translator')->get('Price old'); ?>" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="json_params[brief][<?php echo e($lang); ?>]" class="form-control" rows="5"><?php echo e(old('json_params[brief][' . $lang . ']')); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="json_params[seo_title][<?php echo e($lang); ?>]"
                                                        class="form-control"
                                                        value="<?php echo e(old('json_params[seo_title][' . $lang . ']')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="json_params[seo_keyword][<?php echo e($lang); ?>]"
                                                        class="form-control"
                                                        value="<?php echo e(old('json_params[seo_keyword][' . $lang . ']')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="json_params[seo_description][<?php echo e($lang); ?>]"
                                                        class="form-control"
                                                        value="<?php echo e(old('json_params[seo_description][' . $lang . ']')); ?>">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <li>
                                                <label for="page-<?php echo e($item->id); ?>">
                                                    <input id="page-<?php echo e($item->id); ?>"  name="relation[]"
                                                        <?php echo e($loop->index == 0 ? 'checked' : ''); ?> type="checkbox"
                                                            ...
                                                            <li>
                                                                <label for="page-<?php echo e($item1->id); ?>">
                                                                    <input id="page-<?php echo e($item1->id); ?>"
                                                                         name="relation[]" cl  type="checkbox"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\flavor-fusion\resources\views/admin/pages/cms_products/create.blade.php ENDPATH**/ ?>