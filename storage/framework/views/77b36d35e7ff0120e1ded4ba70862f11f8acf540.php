    ...
    <section id="fhm-breadcrumb" class="breadcrumb">
        <div class="container">
            <div class="breadcrumb-list">
                <a href="<?php echo e(route('home.default')); ?>" title="Home" class="breadcrumb-link">Home</a>
                    ...
                    <div class="product-detail-information-wrapper product">
                        ...
                        <div class="product-detail-information-price product-info">
                            <div class="product-price">
                                <span class="product-price-current">$<?php echo e(number_format($detail->price)); ?></span>
                                <span class="product-price-old">$<?php echo e(number_format($detail->price_old)); ?></span>
                            </div>
                        </div>
            ...
            <div class="swiper product-related">
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            ...
                            <div class="product-info">
                                ...
                                <a href="<?php echo e(route('frontend.page', ['taxonomy' => $item->alias ?? ''])); ?>" class="product-name text-2-line text-short" title="<?php echo e($item->name); ?>">
                                    <?php echo e($item->name); ?>

                                </a>
                                <div class="product-price">
                                    <span class="product-price-current">$<?php echo e(number_format($item->price)); ?></span>
                                    <span class="product-price-old">$<?php echo e(number_format($item->price_old)); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-center">
                    <div class="button button-viewmore">
                        <a href="<?php echo e(route('frontend.page', ['taxonomy' =>  '/product-category/products'])); ?>" title="See All Products">See All Products</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/frontend/pages/product/detail/default.blade.php ENDPATH**/ ?>