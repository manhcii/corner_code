                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="d-flex-wap">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Iframe MAP'); ?></label>
                                            <input type="text" class="form-control" name="json_params[map]"
                                                placeholder="<?php echo app('translator')->get('Iframe MAP'); ?>"
                                                value="<?php echo e($detail->json_params->map ?? old('json_params[map]')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
...
<?php echo $__env->make('admin.layouts.block', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\flavor-fusion\resources\views/admin/pages/block_contents/edit/contact.blade.php ENDPATH**/ ?>