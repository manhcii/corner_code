...
<section class="content">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title"><?php echo app('translator')->get('Block list'); ?></h3>
    </div>
      ...
      <table class="table table-hover table-bordered">
        <thead>
          <tr>
            ...
            <th><?php echo app('translator')->get('Block code'); ?></th>
            <th><?php echo app('translator')->get('Is config'); ?></th>
        ...
        <tbody>
          ...
          <form action="<?php echo e(route(Request::segment(2).'.destroy', $row->id)); ?>" method="POST"
            ...
            <tr class="valign-middle">
              ...
              <td>
                <?php echo e($row->block_code); ?>

              </td>
              <td>
                <?php echo app('translator')->get(App\Consts::TITLE_BOOLEAN[$row->is_config]); ?>
              </td>
              <td>
                <input data-token="<?php echo e(csrf_token()); ?>" data-url="<?php echo e(route('admin.loadOrderVeryModel',['table'=>'blocks','id'=>$row->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($row->iorder?$row->iorder:0); ?>" style="width:50px" />
              </td>
              <td>
                  <?php echo e($row->updated_at); ?>

              </td>
              <td class="wrap-load-active" data-token="<?php echo e(csrf_token()); ?>" data-url="<?php echo e(route('admin.loadStatusBlock',['id'=>$row->id])); ?>">
              ...
              <td>
                ...
                <button class="btn btn-sm btn-danger" type="submit" data-toggle="tooltip" title="<?php echo app('translator')->get('Delete'); ?>"
                  data-original-title="<?php echo app('translator')->get('delete'); ?>" disabled>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\flavor-fusion\resources\views/admin/pages/blocks/index.blade.php ENDPATH**/ ?>