            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="box box-primary">
                        ...
                        <?php endif; ?>
                        <?php
                            $route = $detail->json_params->route_name ?? 'product.detail';
                            $route_default = collect($route_name)->first(function ($item, $key) use ($route) {
                                return $item['name'] == $route;
                            });
                        ?>
                        <?php if($route_default): ?>
                            <input type="hidden" name="json_params[route_name]" value="<?php echo e($route_default['name']); ?>">
                        <?php endif; ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        ...
                                                        value="<?php echo e(old('name') ?? ($detail->json_params->name->$lang ?? $detail->name)); ?>"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="price"
                                                        ...
                                                        value="<?php echo e($detail->price ?? old('price')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="price_old"
                                                        ...
                                                        value="<?php echo e($detail->price_old ?? old('price_old')); ?>">
                                                </div>
                                            </div>
                                ...
                                <?php if($val->parent_id == 0 || $val->parent_id == null): ?>
                                    <div class="form-group">
                                        ...
                                        <ul class="list-relation row">
                                            <input type="hidden"
                                                name="json_params[paramater][<?php echo e($val->id); ?>][name]"
                                                value="<?php echo e(Str::slug($val->name)); ?>">
                                                        ...
                                                        <li>
                                                            <label for="page-<?php echo e($item->id); ?>">
                                                                ...
                                                                <input id="page-<?php echo e($item->id); ?>"
                                                                    name="json_params[paramater][<?php echo e($item->parent_id); ?>][childs][]"
                                                                    type="checkbox"
                                                                    <?php echo e(isset($detail->json_params->paramater->{$item->parent_id}->childs) && isset($detail->json_params->paramater->{$item->parent_id}) && in_array($item->id, $detail->json_params->paramater->{$item->parent_id}->childs) ? 'checked' : ''); ?>
                                        ...
                                        <?php if($item->parent_id == 0 || $item->parent_id == null): ?>
                                            <li>
                                                <label for="category-<?php echo e($item->id); ?>">
                                                    <input id="category-<?php echo e($item->id); ?>" name="relation[]"
                                                ...
                                                <ul class="list-relation">
                                                    <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($item1->parent_id == $item->id): ?>
                                                            <li>
                                                                <label for="category-<?php echo e($item1->id); ?>">
                                                                    <input id="category-<?php echo e($item1->id); ?>"
                                                                ...
                                                                <ul class="list-relation">
                                                                    <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if($item2->parent_id == $item1->id): ?>
                                                                            <li>
                                                                                <label for="category-<?php echo e($item2->id); ?>">
                                                                                    <input
                                                                                        id="category-<?php echo e($item2->id); ?>"
                                                                                        name="relation[]" type="checkbox"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/admin/pages/cms_products/edit.blade.php ENDPATH**/ ?>