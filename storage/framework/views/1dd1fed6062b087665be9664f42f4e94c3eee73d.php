                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="copyright"
                                                ...
                                                value="<?php echo e(old('copyright') ?? ($lang == $languageDefault->lang_locale ? $setting->copyright : $setting->{$lang . '-copyright'})); ?>">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                <?php echo app('translator')->get('Buttom Footer'); ?>
                                            </label>
                                            <input type="text" class="form-control" name="buttom_footer"
                                                placeholder="<?php echo app('translator')->get('Buttom Footer'); ?>"
                                                value="<?php echo e(old('buttom_footer') ?? ($lang == $languageDefault->lang_locale ? $setting->buttom_footer : $setting->{$lang . '-buttom_footer'})); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                <?php echo app('translator')->get('Link Footer'); ?>
                                            </label>
                                            <input type="text" class="form-control" name="link_footer"
                                                placeholder="<?php echo app('translator')->get('Link Footer'); ?>"
                                                value="<?php echo e(old('link_footer') ?? ($lang == $languageDefault->lang_locale ? $setting->link_footer : $setting->{$lang . '-link_footer'})); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\flavor-fusion\resources\views/admin/pages/settings/index.blade.php ENDPATH**/ ?>