            ...
            <ul class="nav-list">
                ...
                <li>
                    ...
                    <ul class="nav-list-lv0 collapse" id="collapsesubmenu-<?php echo e($val_menu1->id); ?>">
                        ...
                        ?>
                        <li>
                            <a href="#" class="nav-item" title="<?php echo e($name); ?>"><?php echo e($name); ?></a>

                            <ul class="nav-list-lv1 collapse" id="collapsesubmenu-lv1-<?php echo e($val_menu2->id); ?>">
                                ...
                                ?>
                                <li>
                                    <a href="<?php echo e($link); ?>" class="nav-item" title="<?php echo e($name); ?>"><?php echo e($name); ?></a>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                            <div class="close-sub-nav collapsed" data-bs-toggle="collapse" href="#collapsesubmenu-lv1-<?php echo e($val_menu2->id); ?>"
                                role="button" aria-expanded="false" aria-controls="collapsesubmenulv1-<?php echo e($val_menu2->id); ?>">
                    ...
                    <div class="close-sub-nav collapsed" data-bs-toggle="collapse" href="#collapsesubmenu-<?php echo e($val_menu1->id); ?>"
                        role="button" aria-expanded="false" aria-controls="collapsesubmenu-<?php echo e($val_menu1->id); ?>">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
                            style="enable-background: new 0 0 512 512" xml:space="preserve">
                            <g>
...
<?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/frontend/components/header_default/menu/layout/mobile.blade.php ENDPATH**/ ?>