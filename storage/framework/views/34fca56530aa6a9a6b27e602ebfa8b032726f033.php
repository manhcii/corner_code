      ...
      <form action="<?php echo e(route(Request::segment(2) . '.index')); ?>" method="GET">
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label><?php echo app('translator')->get('Widget type'); ?></label>
                <select name="widget_code" id="widget_code" class="form-control select2" style="width: 100%;">
                  ...
                  <?php $__currentLoopData = $widget_configs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($item->widget_code); ?>"
                      <?php echo e(isset($params['widget_code']) && $item->widget_code == $params['widget_code'] ? 'selected' : ''); ?>>
    ...
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">
          ...
          <?php echo app('translator')->get('Widget list'); ?>
        </h3>
      </div>
          ...
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                ...
                <th><?php echo app('translator')->get('Widget type'); ?></th>
                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <td>
                        <?php echo e($row->widget_name); ?> (<?php echo e($row->widget_code); ?>)
                      </td>

                      <td>
                        <input data-token="<?php echo e(csrf_token()); ?>" data-url="<?php echo e(route('admin.loadOrderVeryModel',['table'=>'widget','id'=>$row->id])); ?> " class="lb-order text-center"  type="number" min="0" value="<?php echo e($row->iorder?$row->iorder:0); ?>" style="width:50px" />
                      </td>
                      <td>
                          <?php echo e($row->updated_at); ?>

                      </td>
                      <td class="wrap-load-active" data-token="<?php echo e(csrf_token()); ?>" data-url="<?php echo e(route('admin.loadStatusWidget',['id'=>$row->id])); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/admin/pages/widgets/index.blade.php ENDPATH**/ ?>