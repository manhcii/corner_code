                                    ...
                                    <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                                        <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>"
                                            ...
                                            <tr class="valign-middle">
                                                ...
                                                <?php
                                                    $url_mapping = route('frontend.page', ['taxonomy' => App\Consts::ROUTE_TAXONOMY['post'], 'alias' => $row->alias ?? '']);
                                                ?>
                                                <td>
                                                ...
                                                <td>
                                                    <input data-token="<?php echo e(csrf_token()); ?>"
                                                        data-url="<?php echo e(route('admin.loadOrderVeryModel', ['table' => 'postCategory', 'id' => $row->id])); ?> "
                                                ...
                                                <td class="wrap-load-active" data-token="<?php echo e(csrf_token()); ?>"
                                                    data-url="<?php echo e(route('admin.loadStatusPostCategory', ['id' => $row->id])); ?>">
                                            ...
                                            <?php if($sub->parent_id == $row->id): ?>
                                                <form action="<?php echo e(route(Request::segment(2) . '.destroy', $sub->id)); ?>"
                                                    ...
                                                    <tr class="valign-middle bg-gray-light">
                                                        ...
                                                        <?php
                                                            $url_mapping = route('frontend.page', ['taxonomy' => App\Consts::ROUTE_TAXONOMY['post'], 'alias' => $sub->alias ?? '']);
                                                        ?>
                                                        <td>
                                                            <a href="<?php echo e($url_mapping); ?>" target="_blank"
                                                                rel="noopener noreferrer"><?php echo e($url_mapping); ?></a>
                                                        ...
                                                        <td>
                                                            - - - -<input data-token="<?php echo e(csrf_token()); ?>"
                                                                data-url="<?php echo e(route('admin.loadOrderVeryModel', ['table' => 'postCategory', 'id' => $sub->id])); ?> "
                                                        ...
                                                        <td class="wrap-load-active" data-token="<?php echo e(csrf_token()); ?>"
                                                            data-url="<?php echo e(route('admin.loadStatusPostCategory', ['id' => $sub->id])); ?>">
                                                            <?php echo $__env->make(
                                                    ...
                                                    <?php if($sub_child->parent_id == $sub->id): ?>
                                                        <form
                                                            ...
                                                            <tr class="valign-middle bg-gray-light">
                                                                ...
                                                                <?php
                                                                    $url_mapping = route('frontend.page', ['taxonomy' => App\Consts::ROUTE_TAXONOMY['post'], 'alias' => $sub_child->alias ?? '']);
                                                                ?>
                                                                <td>
                                                                    <a href="<?php echo e($url_mapping); ?>" target="_blank"
                                                                        rel="noopener noreferrer"><?php echo e($url_mapping); ?></a>
                                                                ...
                                                                <td>
                                                                    - - - - -<input data-token="<?php echo e(csrf_token()); ?>"
                                                                        data-url="<?php echo e(route('admin.loadOrderVeryModel', ['table' => 'postCategory', 'id' => $sub_child->id])); ?> "
                                                                        class="lb-order text-center" type="number"
                                                                        min="0"
                                                                ...
                                                                <td class="wrap-load-active"
                                                                    ...
                                                                    data-url="<?php echo e(route('admin.loadStatusPostCategory', ['id' => $sub_child->id])); ?>">
                                                                    <?php echo $__env->make(
                                                                        'admin.components.load-change-status',
                                                                        [
                                                                            'data' => $sub_child,
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/admin/pages/post_category/index.blade.php ENDPATH**/ ?>