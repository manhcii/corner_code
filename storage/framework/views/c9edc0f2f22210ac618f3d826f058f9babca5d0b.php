    ...
    <form role="form" action="<?php echo e(route(Request::segment(2).'.update', $detail->id)); ?>" method="POST">
      ...
      <div class="box-body">
        <div class="col-md-6">
          ...
          <div class="form-group">
            <label>
              <?php echo app('translator')->get('component_code'); ?> <small class="text-red">*</small>: 
              <small>
                <i>
            ...
            <input type="text" class="form-control" name="component_code" placeholder="<?php echo app('translator')->get('component_code'); ?>"
              value="<?php echo e($detail->component_code); ?>" required>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\flavor-fusion\resources\views/admin/pages/component_configs/edit.blade.php ENDPATH**/ ?>