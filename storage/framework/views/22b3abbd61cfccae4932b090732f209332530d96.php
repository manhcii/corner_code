<?php if($block): ?>
    ...
    <section id="fhm-guiding-story" class="guiding-story commitment">
        <div class="guiding-story-background position-absolute">
        </div>
        <div class="container">
...
<?php endif; ?>
<?php /**PATH C:\xamppp\htdocs\flavor-fusion\resources\views/frontend/blocks/service_block/styles/block_reverse.blade.php ENDPATH**/ ?>