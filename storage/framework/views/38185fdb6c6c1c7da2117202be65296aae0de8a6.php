...
<div class="products-filter-item">
    <div class="products-filter-item-heading d-flex justify-content-between align-items-center"
        ...
        <h2 class="heading">
            <?php echo e($detail_paramate->name); ?> <span class="quantity">(22)</span>
        </h2>
    ...
    <div id="filter-brand" class="collapse show">
        ...
        <ul class="products-filter-item-criteria" data-type="checkbox">
            <?php $__currentLoopData = $paramate_childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li>
                <div class="checkbox" data-status="check"></div>
                <p class="text">
                    <?php echo e($item->name); ?> <span class="quantity">(<?php echo e($item->count()); ?>)</span>
                </p>
            </li>
...
<?php endif; ?>
<?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/frontend/components/sidebar_product/properties/layout/brand.blade.php ENDPATH**/ ?>