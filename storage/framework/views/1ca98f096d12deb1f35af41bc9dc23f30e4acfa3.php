                                                                        ...
                                                                        <div class="box-body">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="json_params[style]"
                                                                                    ...
                                                                                    class="form-control select2"
                                                                                    autocomplete="off">
                                                                                    <option value=""><?php echo app('translator')->get('Please select'); ?>
                                                                                    </option>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input id="image_add"
                                                                                        class="form-control"
                                                                                        type="text" name="json_params[image]"
                                                                    ...
                                                                    <div class="item-details collapse multi-collapse"
                                                                        ...
                                                                        <form role="form"
                                                                            ...
                                                                            <div class="form-body">
                                                                                ...
                                                                                <div class="image-mega form-group mb-3">
                                                                                    <label for="menu-node-title-1"
                                                                                        class="control-label"
                                                                                        data-update="title"><?php echo app('translator')->get('Image Url Title'); ?></label>
                                                                                    <input class="form-control"
                                                                                        placeholder="Image Title"
                                                                                        name="json_params[img_title]"
                                                                                        type="text"
                                                                                        value="<?php echo e($item->json_params->img_title ?? ''); ?>">
                                                                                </div>
                                                                                <div class="image-mega form-group mb-3">
                                                                                    <label for="menu-node-title-1"
                                                                                        class="control-label"
                                                                                        data-update="title"><?php echo app('translator')->get('Image Url Link'); ?></label>
                                                                                    <input class="form-control"
                                                                                        placeholder="Image Link"
                                                                                        name="json_params[img_link]"
                                                                                        type="text"
                                                                                        value="<?php echo e($item->json_params->img_link ?? ''); ?>">
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label><?php echo app('translator')->get('Image'); ?></label>
                                                                                    <div class="input-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/admin/pages/menus/edit.blade.php ENDPATH**/ ?>