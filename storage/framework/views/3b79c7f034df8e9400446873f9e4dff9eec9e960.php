              ...
              ?>
                    <div class="swiper-slide">
                        <div class="product-item">
                            <div class="product-img">
                                <a href="<?php echo e($item->alias); ?>" title="Empire Design">
                                    <img src="<?php echo e($item->image); ?>" alt="Empire Design"
                                        title="Empire Design" />
                                </a>
                                ...
                                <button class="main-btn position-absolute add-to-cart " data-id="<?php echo e($id); ?>"
                            ...
                            <div class="product-info">
                                <span class="product-type"><?php echo e($category->name); ?></span>
                                <a href="<?php echo e($item->alias); ?>" class="product-name text-2-line text-short" title="Empire Design">
                                   <?php echo e($item->name); ?>

                                </a>
                                <div class="product-price">
                                    <span class="product-price-current">$ <?php echo e(number_format($price, 0, ",", ".")); ?></span>
                                    <span class="product-price-old">$ <?php echo e(number_format($price_old, 0, ",", ".")); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-center">
                    <div class="button button-viewmore">
                        <a href="<?php echo e(route('frontend.page',['taxonomy' => 'product-category/products'])); ?>" title="View All Products">View All Products</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/frontend/blocks/cms_product/styles/bestseller.blade.php ENDPATH**/ ?>