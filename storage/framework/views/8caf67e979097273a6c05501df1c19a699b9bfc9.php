                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="d-flex-wap">
                                    ...
                                    <div class="col-12 col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Star'); ?></label>
                                            <input type="number" min="0" max="5" class="form-control" name="json_params[star]"
                                                placeholder="<?php echo app('translator')->get('Star'); ?>"
                                                value="<?php echo e(old('json_params[star]') ?? ($detail->json_params->star??'')); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.block', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/admin/pages/block_contents/edit/block_star.blade.php ENDPATH**/ ?>