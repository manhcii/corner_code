        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            <label>
              ...
              <small>
                <i>
                  Nên viết theo chức năng của Widgets
                </i>
              </small
              ></label>
          ...
          <div class="form-group">
            <label>
              <?php echo app('translator')->get('widget_code'); ?> <small class="text-red">*</small>: 
              <small>
                <i>
                  Viết theo tên file view Widgets
                </i>
              </small>
            </label>
            <input type="text" class="form-control" name="widget_code" placeholder="<?php echo app('translator')->get('widget_code'); ?>"
              value="<?php echo e($detail->widget_code); ?>" required>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\flavor-fusion\resources\views/admin/pages/widget_configs/edit.blade.php ENDPATH**/ ?>