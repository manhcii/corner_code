<?php $__env->startSection('content'); ?>
    ...
    <section id="fhm-collections-banner" class="position-relative">
        <div class="banner-image">
            <img src="<?php echo e('/themes/frontend/corner/assets/breadcrumb.png'); ?>" alt="<?php echo e($category_title); ?>"
                title="<?php echo e($category_title); ?>" />
        </div>
    ...
    <section id="fhm-breadcrumb" class="breadcrumb">
        <div class="container">
            <div class="breadcrumb-list">
                <a href="<?php echo e(route('home.default')); ?>" title="Home" class="breadcrumb-link" title="Home">Home</a>
                ...
                <a href="#" title="<?php echo e($category_title); ?>" class="breadcrumb-link"><?php echo e($category_title); ?></a>
            </div>
        </div>
    </section>
                                    ...
                                    <?php if(\View::exists('frontend.widgets.sidebar.' . $widget->sidebar->json_params->layout)): ?>
                                        <?php echo $__env->make(
                                            'frontend.widgets.sidebar.' .
                                                $widget->sidebar->json_params->layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php else: ?>
                            ...
                            <div class="products-list-grids">
                                ...
                                <div class="product-item">
                                    <div class="product-img">
                                        ...
                                        <button class="main-btn position-absolute add-to-cart" data-id="<?php echo e($item->id); ?>"
                                    ...
                                    <div class="product-info">
                                        ...
                                        <a href="<?php echo e(route('frontend.page', ['taxonomy' => $item->alias ?? ''])); ?>" class="product-name text-2-line text-short"
                                            title="<?php echo e($item->name); ?>">
                                            <?php echo e($item->name); ?>

                                        </a>
                                        <div class="product-price">
                                            <span class="product-price-current">$<?php echo e(number_format($item->price)); ?></span>
                                            <span class="product-price-old">$<?php echo e(number_format($item->price)); ?></span>
                                        </div>
                                    </div>
                                </div>
...
<script src="<?php echo e(asset('themes/frontend/corner/js/rangeslider.umd.min.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/corner/js/collections.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\corner\shushi\resources\views/frontend/pages/product/category/default.blade.php ENDPATH**/ ?>